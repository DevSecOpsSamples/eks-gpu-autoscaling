"use strict";var _a;Object.defineProperty(exports,"__esModule",{value:!0}),exports.LambdaDestination=void 0;const jsiiDeprecationWarnings=require("../../.warnings.jsii.js"),JSII_RTTI_SYMBOL_1=Symbol.for("jsii.rtti"),iam=require("../../aws-iam"),s3=require("../../aws-s3"),core_1=require("../../core"),constructs_1=require("constructs");class LambdaDestination{constructor(fn){this.fn=fn,jsiiDeprecationWarnings.aws_cdk_lib_aws_lambda_IFunction(fn)}bind(_scope,bucket){jsiiDeprecationWarnings.aws_cdk_lib_aws_s3_IBucket(bucket);const permissionId=`AllowBucketNotificationsTo${core_1.Names.nodeUniqueId(this.fn.permissionsNode)}`;if(!(bucket instanceof constructs_1.Construct))throw new Error(`LambdaDestination for function ${core_1.Names.nodeUniqueId(this.fn.permissionsNode)} can only be configured on a
